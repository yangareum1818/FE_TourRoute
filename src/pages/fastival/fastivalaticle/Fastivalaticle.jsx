	...
	return (
		<Wrapper>
			<TitleDiv>
				...
				<AticleDate>2023. 08. 26 - 2023.08. 27</AticleDate>
				<AticleHeart>
					<WishHeartIcon />
				</AticleHeart>
			</TitleDiv>
			<ContentDiv>
				<ContentTitle>2023 부산나이트워크 42K</ContentTitle>
				<ContentImg src={img} />
				<ContentText dangerouslySetInnerHTML={{ __html: transform(text) }} />
				<AlertDiv>
					<InfoDiv>
						<FaCircleInfo />
					</InfoDiv>
